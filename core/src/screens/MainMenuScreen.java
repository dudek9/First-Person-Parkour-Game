...
//       leaderboardsButton = new TextButton("Leaderboards",
//       Assets.skin); 
   ...
   private void configureWidgers() { 
       ...
       titleImage.getWidth()
       / 2, Core.VIRTUAL_HEIGHT / 2); 
       playButton.setSize(128, 64); 
       playButton.setPosition(Core.VIRTUAL_WIDTH / 2 -
       playButton.getWidth()
       / 2, Core.VIRTUAL_HEIGHT / 2 - 130); 
//       leaderboardsButton.setSize(128, 64); 
//       leaderboardsButton.setPosition(Core.VIRTUAL_WIDTH / 2 -
//       playButton.getWidth() / 2, Core.VIRTUAL_HEIGHT / 2 - 170); 
       quitButton.setSize(128, 64); 
       quitButton.setPosition(Core.VIRTUAL_WIDTH / 2 -
       playButton.getWidth()
       / 2, Core.VIRTUAL_HEIGHT / 2 - 210); 
